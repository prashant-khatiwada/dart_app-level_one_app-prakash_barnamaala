...
const List<MenuModal> choices = const <MenuModal>[
  const MenuModal(
      title: 'Essential',
      secondTitle: 'आवश्यक',
      image: "assets/image_menu/menu_phrase_01.png",
      menuNumber: 1),
  const MenuModal(
      title: 'Travel',
      secondTitle: 'यात्रा',
      image: "assets/image_menu/menu_phrase_02.png",
      menuNumber: 2),
  const MenuModal(
      title: 'Lodging',
      secondTitle: 'लजिंग',
      image: "assets/image_menu/menu_phrase_03.png",
      menuNumber: 3),
  const MenuModal(
      title: 'Dining',
      secondTitle: 'भोजन',
      image: "assets/image_menu/menu_phrase_04.png",
      menuNumber: 4),
  const MenuModal(
      title: 'Time',
      secondTitle: 'समय',
      image: "assets/image_menu/menu_phrase_05.png",
      menuNumber: 5),
  const MenuModal(
      title: 'Technology',
      secondTitle: 'प्रविधि',
      image: "assets/image_menu/menu_phrase_06.png",
      menuNumber: 6),
  const MenuModal(
      title: 'Health',
      secondTitle: 'स्वास्थ्य',
      image: "assets/image_menu/menu_phrase_07.png",
      menuNumber: 7),
  const MenuModal(
      title: 'Emergency',
      secondTitle: 'आपातकालीन',
      image: "assets/image_menu/menu_phrase_08.png",
      menuNumber: 8),
];
...
class PhrasePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    switch (menuNumber) {
      case (1):
        return new Scaffold(body: PhraseEssential());
        break;
      case (2):
        return new Scaffold(body: PhraseTravel());
        break;
      case (3):
        return new Scaffold(body: PhraseLodging());
        break;
      case (4):
        return new Scaffold(body: PhraseDining());
        break;
      case (5):
        return new Scaffold(body: PhraseTime());
        break;
      case (6):
        return new Scaffold(body: PhraseTechnology());
        break;
      case (7):
        return new Scaffold(body: PhraseHealth());
        break;
      case (8):
        return new Scaffold(body: PhraseEmergency());
        break;
    // Add default list
      default:
        return new Scaffold(body: PhraseEssential());
